...
The function computes p-values from the GeneScan3D test for the original genotype data, and each of the M=5 multiple knockoff replicates. The knockoff generations are optimized using shrinkage leveraging algorithm.
